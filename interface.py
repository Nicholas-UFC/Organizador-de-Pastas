...
class AppOrganizador(tk.Tk):
    ...
    pasta_selecionada: (
        tk.StringVar
    )  # Variável especial do Tkinter que armazena o caminho da pasta selecionada pelo usuário.
    ...
    def carregar_regras(self) -> None:
        ...
        try:
            ...
            messagebox.showerror(
                "Erro Crítico",
                "O arquivo de configuração 'regras.json' não foi encontrado!\nA aplicação não pode continuar.",
            )
            self.destroy()
    ...
    def _criar_widgets(self) -> None:
        ...
        tk.Label(
            main_frame,
            text="Selecione a pasta que deseja organizar:",
            font=("Arial", 12),
        ).pack(pady=(0, 10))
